...
def plot_hist(input_file, input_file_directory, x_label, output_name):
    ...
    file=ROOT.TFile(input_file, "r")
    
    Data=file.Get(input_file_directory).Get("data_obs")
    TT=file.Get(input_file_directory).Get("TTTo2L2Nu")
    VV=file.Get(input_file_directory).Get("WW")
    DY=file.Get(input_file_directory).Get("DY")
    Fake=file.Get(input_file_directory).Get("Fake")
...
def main():
    input_file = "datacard_mutau.root"
    plot_hist(input_file, "OSiso", "m_{vis}", "m_vis")
